...
class SchemaChain {
   ...
   * @method alter
   */
  alter (tableName:string, callback:(table:TableBuilder) => void) {
   ...
   * @method create
   */
  create (tableName:string, callback:(table:TableBuilder) => void) {
   ...
   */
  createIfNotExists (tableName:string, callback:(table:TableBuilder) => void) {
   ...
   * @method rename
   */
  rename (fromTable:string, toTable:string) {
