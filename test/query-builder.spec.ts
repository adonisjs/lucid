...
test.group('Query Builder | whereIn', (group) => {
  ...
  test('add whereIn as a subquery', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .whereIn('username', getQueryBuilder(connection.getClient()).select('id').from('accounts'))
      .toSQL()
  ...
  test('add whereIn as a subquery with array of keys', (assert) => {
    ...
    const { sql, bindings } = db
      ...
      .whereIn(
        ['username', 'email'],
        getQueryBuilder(connection.getClient()).select('username', 'email').from('accounts'),
      )
      .toSQL()
...
test.group('Query Builder | whereNotIn', (group) => {
  ...
  test('add whereNotIn as a sub query', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .whereNotIn('username', getQueryBuilder(connection.getClient()).select('username').from('accounts'))
      .toSQL()
...
test.group('Query Builder | whereExists', (group) => {
  ...
  test('add where exists clause as a subquery', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .whereExists(getQueryBuilder(connection.getClient()).from('accounts'))
      .toSQL()
  ...
  test('add or where exists clause as a subquery', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .orWhereExists(getQueryBuilder(connection.getClient()).from('accounts'))
      .toSQL()
...
test.group('Query Builder | whereNotExists', (group) => {
  ...
  test('add where exists clause as a subquery', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .whereNotExists(getQueryBuilder(connection.getClient()).from('accounts'))
      .toSQL()
  ...
  test('add or where exists clause as a subquery', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .orWhereNotExists(getQueryBuilder(connection.getClient()).from('accounts'))
      .toSQL()
...
test.group('Query Builder | union', (group) => {
  ...
  test('define union query as a subquery', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .union(getQueryBuilder(connection.getClient()).from('users').whereNull('first_name'))
      .toSQL()
...
test.group('Query Builder | unionAll', (group) => {
  ...
  test('define unionAll query as a subquery', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .unionAll(getQueryBuilder(connection.getClient()).from('users').whereNull('first_name'))
      .toSQL()
  ...
  test('add having clause value being a sub query', (assert) => {
    ...
    const { sql, bindings } = db
      ...
      .having(
        'user_id',
        '=',
        getQueryBuilder(connection.getClient()).from('accounts').select('id'),
      )
      .toSQL()
...
test.group('Query Builder | havingIn', (group) => {
  ...
  test('add having in clause values as subqueries', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .havingIn('id', [getQueryBuilder(connection.getClient()).select('id').from('accounts')])
      .toSQL()
...
test.group('Query Builder | havingNotIn', (group) => {
  ...
  test('add having in clause values as subqueries', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .havingNotIn('id', [getQueryBuilder(connection.getClient()).select('id').from('accounts')])
      .toSQL()
...
test.group('Query Builder | havingExists', (group) => {
  ...
  test('add having exists clause as a subquery', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .havingExists(getQueryBuilder(connection.getClient()).select('*').from('accounts'))
      .toSQL()
...
test.group('Query Builder | havingNotExists', (group) => {
  ...
  test('add having not exists clause as a subquery', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .havingNotExists(getQueryBuilder(connection.getClient()).select('*').from('accounts'))
      .toSQL()
...
test.group('Query Builder | havingBetween', (group) => {
  ...
  test('add having between clause with subqueries', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .havingBetween('id', [
        getQueryBuilder(connection.getClient()).select('id'),
        getQueryBuilder(connection.getClient()).select('id'),
      ])
      .toSQL()
...
test.group('Query Builder | count', (group) => {
  ...
  test('count by subquery', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .count(getQueryBuilder(connection.getClient()).where('is_verified', true).from('profiles'), 'u')
      .toSQL()
  ...
  test('count by subquery on multiple columns', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .count({
        u: getQueryBuilder(connection.getClient()).where('is_verified', true).from('profiles'),
        e: 'email',
      })
      .toSQL()
...
test.group('Query Builder | countDistinct', (group) => {
  ...
  test('count by subquery', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .countDistinct(getQueryBuilder(connection.getClient()).where('is_verified', true).from('profiles'), 'u')
      .toSQL()
...
test.group('Query Builder | min', (group) => {
  ...
  test('use subqueries to compute min', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .min(getQueryBuilder(connection.getClient()).where('is_verified', true).from('profiles'), 'u')
      .toSQL()
...
test.group('Query Builder | max', (group) => {
  ...
  test('use subqueries to compute max', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .max(getQueryBuilder(connection.getClient()).where('is_verified', true).from('profiles'), 'u')
      .toSQL()
...
test.group('Query Builder | sum', (group) => {
  ...
  test('use subqueries to compute sum', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .sum(getQueryBuilder(connection.getClient()).where('is_verified', true).from('profiles'), 'u')
      .toSQL()
...
test.group('Query Builder | avg', (group) => {
  ...
  test('use subqueries to compute avg', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .avg(getQueryBuilder(connection.getClient()).where('is_verified', true).from('profiles'), 'u')
      .toSQL()
...
test.group('Query Builder | avgDistinct', (group) => {
  ...
  test('use subqueries to compute avgDistinct', (assert) => {
    ...
    const { sql, bindings } = db
      .from('users')
      .avgDistinct(getQueryBuilder(connection.getClient()).where('is_verified', true).from('profiles'), 'u')
      .toSQL()
